...
function axiom_render_custom_thankyou_header($order_id) {
    ...
    if ($is_zelle) {
        ...
        echo '          <div class="axiom-payment-copy-field"><span>Zelle email</span><div class="axiom-payment-copy-row"><strong>realaxiompeptides@gmail.com</strong><button type="button" class="axiom-copy-button" onclick="axiomCopyValue(this, \'realaxiompeptides@gmail.com\')">Copy</button></div></div>';
