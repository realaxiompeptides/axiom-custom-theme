...
<div class="axiom-account-page">
  <div class="container">
    <div class="axiom-account-shell">

      <div class="axiom-account-hero">
        <p class="axiom-account-kicker">My Account</p>
        <h1>Welcome back</h1>
        <p class="axiom-account-subtitle">
          Log in to access your account, track orders, manage your details, and view your affiliate or customer activity.
        </p>
      </div>

      <div class="axiom-account-login-wrap">
        <div class="axiom-account-card">

          <div class="axiom-account-card-header">
            <h2>Login</h2>
            <p>Enter your email or username and password to continue.</p>
          </div>
          ...
          <form class="woocommerce-form woocommerce-form-login login" method="post">
            ...
            <div class="axiom-account-actions">
        ...
        <?php if ('yes' === get_option('woocommerce_enable_myaccount_registration')) : ?>
          <div class="axiom-account-card axiom-account-register-card">
            <div class="axiom-account-card-header">
              <h2>Create an account</h2>
              <p>Register to manage orders faster and keep your account details saved.</p>
            </div>
